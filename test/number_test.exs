defmodule NumberTest do
  ...
  describe "ordering" do
    ...
    test "+10 + -15" do
      assert Number.positive(10)
             |> Number.add(Number.negative(15))
             |> Number.equal?(Number.negative(5))
    end

    test "+15 + -10" do
      assert Number.positive(15)
             |> Number.add(Number.negative(10))
             |> Number.equal?(Number.positive(5))
    end

    test "-15 + +10" do
      assert Number.negative(15)
             |> Number.add(Number.positive(10))
             |> Number.equal?(Number.negative(5))
    end
