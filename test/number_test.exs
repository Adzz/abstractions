defmodule NumberTest do
  ...
  describe "subtraction" do
    test "+15 - +10" do
      assert Number.subtract(Number.positive(15), Number.positive(10)) == Number.positive(5)
    end

    test "+10 - +15" do
      assert Number.subtract(Number.positive(10), Number.positive(15)) == Number.negative(5)
    end

    test "-5 - -10" do
      assert Number.subtract(Number.negative(5), Number.negative(10)) == Number.positive(5)
    end

    test "-10 - -5" do
      assert Number.subtract(Number.negative(10), Number.negative(5)) == Number.negative(5)
    end

    test "-10 - +15" do
      assert Number.subtract(Number.negative(10), Number.positive(15)) == Number.negative(25)
    end

    test "+10 - -15" do
      assert Number.subtract(Number.positive(10), Number.negative(15)) == Number.positive(25)
    end

    test "+15 - -10" do
      assert Number.subtract(Number.positive(15), Number.negative(10)) == Number.positive(25)
    end

    test "-15 - +10" do
      assert Number.subtract(Number.negative(15), Number.positive(10)) == Number.negative(25)
    end
  ...
  describe "multiplication" do
    test "+2 × +3 = +6" do
      assert Number.multiply(Number.positive(2), Number.positive(3)) == Number.positive(6)
    end

    test "-2 × -3 = +6" do
      assert Number.multiply(Number.negative(2), Number.negative(3)) == Number.positive(6)
    end

    test "+2 × -3 = -6'" do
      assert Number.multiply(Number.positive(2), Number.negative(3)) == Number.negative(6)
    end

    test "-2 × +3 = -6" do
      assert Number.multiply(Number.negative(2), Number.positive(3)) == Number.negative(6)
    end
